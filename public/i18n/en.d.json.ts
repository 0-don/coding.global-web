...
declare const messages: {
	...
	"METADATA": {
		"ROOT": {
			"DESCRIPTION": "Official Coding Global Website for Programmers Worldwide. Join 6,600+ developers in our international community for coding help, discussions, and tech networking.",
			"KEYWORDS": "Coding Global, Discord Community, Programming, Developers, EN, GER, coding community, developer network",
			"TITLE": "Coding Global [EN/GER]"
		},
		"NOT_FOUND": {
			"DESCRIPTION": "The page you're looking for doesn't exist. Return to our coding community homepage to explore programming resources and discussions.",
	...
	"MAIN": {
		...
		"ERROR": {
			...
			"UNEXPECTED_ERROR_OCCURRED": "An unexpected error occurred. Please try again or return to the home page."
		},
		"MANIFEST": {
			"DESCRIPTION": "Join our thriving coding community with 6,600+ members. Get help, share projects, and connect with programmers of all skill levels.",
			"SHORT_NAME": "Coding",
			"TITLE": "{appName} - Programming Community"
		},
		"META": {
