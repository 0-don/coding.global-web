...
import { HiOutlineBookOpen, HiOutlineCodeBracket, HiOutlineLink, HiOutlineRocketLaunch } from "react-icons/hi2";
...
export default function JavascriptPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">JavaScript Resources</h1>

      <section id="overview" className="mb-12 scroll-mt-20">
        <h2 className="text-2xl font-semibold mb-4">Overview</h2>
        <p className="text-muted-foreground">
          JavaScript is a versatile programming language that powers the modern web.
          It runs in browsers and on servers (Node.js), making it essential for full-stack development.
        </p>
      </section>
      ...
      <section id="getting-started" className="mb-12 scroll-mt-20">
        ...
        <p className="text-muted-foreground">
          Start your JavaScript journey with the fundamentals: variables, functions,
          and control flow. Then move on to modern ES6+ features like arrow functions,
      ...
      <section id="resources" className="mb-12 scroll-mt-20">
        ...
        <p className="text-muted-foreground">
          ...
          for continuing your JavaScript learning.
        </p>
      </section>
    </div>
  );
