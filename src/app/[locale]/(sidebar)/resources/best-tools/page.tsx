...
export default function BestToolsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="mb-8 text-3xl font-bold">Best Tools</h1>

      <section id="editors" className="mb-12 scroll-mt-20">
        <h2 className="mb-4 text-2xl font-semibold">Code Editors & IDEs</h2>
      ...
      <section id="terminal" className="mb-12 scroll-mt-20">
        <h2 className="mb-4 text-2xl font-semibold">Terminal Tools</h2>
        <p className="text-muted-foreground">
          Level up your command line experience with modern terminals, shell
          configurations, and CLI tools. Discover tools like Warp, Oh My Zsh,
          and essential command-line utilities.
        </p>
      </section>

      <section id="cloud" className="mb-12 scroll-mt-20">
        <h2 className="mb-4 text-2xl font-semibold">Cloud Services</h2>
        <p className="text-muted-foreground">
      ...
      <section id="extensions" className="mb-12 scroll-mt-20">
        <h2 className="mb-4 text-2xl font-semibold">Extensions & Plugins</h2>
        <p className="text-muted-foreground">
          Must-have extensions for your editor and browser. Productivity
          boosters, code formatters, AI assistants, and tools that streamline
          your development process.
        </p>
      </section>

      <section id="utilities" className="mb-12 scroll-mt-20">
        <h2 className="mb-4 text-2xl font-semibold">Development Utilities</h2>
        <p className="text-muted-foreground">
          Handy utilities for everyday development tasks. API testing tools,
          database managers, design tools, and other software that makes coding
          more efficient.
        </p>
      </section>
    </div>
