...
const BOARD_TYPE: ProgrammingThreadType = "dart";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.DART.META.TITLE"),
    description: t("CODING.DART.META.DESCRIPTION"),
    keywords: t("CODING.DART.META.KEYWORDS"),
  });
}

export default async function DartDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
