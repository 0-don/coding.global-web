...
const BOARD_TYPE: ProgrammingThreadType = "visual-basic";
...
export async function generateMetadata(props: {
  ...
  return getPageMetadata({
    locale,
    title: t("CODING.VISUAL_BASIC.META.TITLE"),
    description: t("CODING.VISUAL_BASIC.META.DESCRIPTION"),
    keywords: t("CODING.VISUAL_BASIC.META.KEYWORDS"),
  });
}

export default async function VisualBasicPage() {
