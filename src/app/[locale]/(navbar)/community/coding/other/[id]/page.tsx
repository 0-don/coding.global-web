...
const BOARD_TYPE: ProgrammingThreadType = "other";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.OTHER.META.TITLE"),
    description: t("CODING.OTHER.META.DESCRIPTION"),
    keywords: t("CODING.OTHER.META.KEYWORDS"),
  });
}

export default async function OtherDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
