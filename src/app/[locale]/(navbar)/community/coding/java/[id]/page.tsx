...
const BOARD_TYPE: ProgrammingThreadType = "java";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.JAVA.META.TITLE"),
    description: t("CODING.JAVA.META.DESCRIPTION"),
    keywords: t("CODING.JAVA.META.KEYWORDS"),
  });
}

export default async function JavaDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
