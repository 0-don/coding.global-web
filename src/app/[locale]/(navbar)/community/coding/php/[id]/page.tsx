...
const BOARD_TYPE: ProgrammingThreadType = "php";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.PHP.META.TITLE"),
    description: t("CODING.PHP.META.DESCRIPTION"),
    keywords: t("CODING.PHP.META.KEYWORDS"),
  });
}

export default async function PhpDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
