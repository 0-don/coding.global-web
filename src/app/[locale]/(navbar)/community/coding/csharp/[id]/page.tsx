...
const BOARD_TYPE: ProgrammingThreadType = "csharp";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.CSHARP.META.TITLE"),
    description: t("CODING.CSHARP.META.DESCRIPTION"),
    keywords: t("CODING.CSHARP.META.KEYWORDS"),
  });
}

export default async function CSharpDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
