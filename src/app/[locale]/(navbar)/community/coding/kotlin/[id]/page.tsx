...
const BOARD_TYPE: ProgrammingThreadType = "kotlin";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.KOTLIN.META.TITLE"),
    description: t("CODING.KOTLIN.META.DESCRIPTION"),
    keywords: t("CODING.KOTLIN.META.KEYWORDS"),
  });
}

export default async function KotlinDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
