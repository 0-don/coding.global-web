...
const BOARD_TYPE: ProgrammingThreadType = "html-css";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.HTML_CSS.META.TITLE"),
    description: t("CODING.HTML_CSS.META.DESCRIPTION"),
    keywords: t("CODING.HTML_CSS.META.KEYWORDS"),
  });
}

export default async function HtmlCssDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
