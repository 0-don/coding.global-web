...
const BOARD_TYPE: ProgrammingThreadType = "c";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.C.META.TITLE"),
    description: t("CODING.C.META.DESCRIPTION"),
    keywords: t("CODING.C.META.KEYWORDS"),
  });
}

export default async function CDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
