...
const BOARD_TYPE: ProgrammingThreadType = "swift";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.SWIFT.META.TITLE"),
    description: t("CODING.SWIFT.META.DESCRIPTION"),
    keywords: t("CODING.SWIFT.META.KEYWORDS"),
  });
}

export default async function SwiftDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
