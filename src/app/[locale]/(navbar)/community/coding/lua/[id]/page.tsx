...
const BOARD_TYPE: ProgrammingThreadType = "lua";
...
export async function generateMetadata(props: {
  ...
  return getThreadPageMetadata(thread, locale, {
    title: t("CODING.LUA.META.TITLE"),
    description: t("CODING.LUA.META.DESCRIPTION"),
    keywords: t("CODING.LUA.META.KEYWORDS"),
  });
}

export default async function LuaDetailPage(props: {
  params: Promise<{ locale: string; id: string }>;
}) {
