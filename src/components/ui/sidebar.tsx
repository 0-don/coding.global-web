...
import { useIsMobile } from "@/hook/ui/use-mobile";
    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:ring-sidebar-border flex size-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[collapsible=icon]:overflow-visible"
        >
          {children}
        </div>
      </div>
