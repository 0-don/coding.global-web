  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center px-4 z-10">
      <div className="w-full max-w-md text-center">
        <div className="bg-black bg-opacity-70 border border-red-500 p-4 rounded-lg mb-6 text-sm font-mono text-red-400 shadow-lg">
          ...
          <div className="flex flex-wrap items-center justify-center space-x-1">
            ...
            <span className="text-red-400 font-bold">Coding Global Website</span>
          </div>
